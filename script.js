...
const translations = {
    ...
    'about.close': { pt: 'Em 2023 matriculei-me no ISEC para formalizar a minha formação em Engenharia Informática. Realizei com sucesso o meu estágio curricular na Critical Software (divisão ASD / SpaceForce), no projeto Lighthouse (Karvel), terminando em Julho de 2026, focado em processamento e transmissão de telemetrias e envio de telecomandos para missões de satélites. O elevado rigor e qualidade técnica são o meu padrão.', en: 'In 2023 I enrolled at ISEC to formalize my practice in Computer Engineering. I successfully completed my Software Engineering Internship at Critical Software (ASD / SpaceForce division), working on the Lighthouse (Karvel) project, concluded in Jun. 2026, focused on telemetry processing, transmission, and command uplinks for satellite missions. High rigor and technical quality remain my standard.' },
